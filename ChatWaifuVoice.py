...
import openai
openai.api_key = 'J2WWf1rVHnDHjxSnZxUxT3BlbkFJcHDWmgMTbZmaOyGDTTyN'

# def call_chatgpt(prompt, model='text-davinci-002', max_tokens=100):
#     data = {
#         'model': model,
#         'prompt': prompt,
...
from ChatOpenAI import GenerateText
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if language_id == 0 and model_id == 0: #input=cn output=cn
            prompt = voice_input_cn()
            print(prompt)
            answer = generateText.getText(prompt)
            if(answer == "quit"):
                break
            print("ChatGPT:")
            print(answer)
